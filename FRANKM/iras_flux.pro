FUNCTION iras_flux,aarstart,iras12=i12,iras25=i25,iras60=i60,iras100=i100
...
;oplot,[12,25,60,100],[result1, result2, result3, result4],psym=2,color=200
  ...
  IF keyword_set(i12)  THEN return,result1
  IF keyword_set(i25)  THEN return,result2
  IF keyword_set(i60)  THEN return,result3
  IF keyword_set(i100) THEN return,result4
