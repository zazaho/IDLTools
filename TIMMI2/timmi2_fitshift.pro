FUNCTION timmi2_fitshift_fitfunction,p
  COMMON COMMON_timmi2_fitshift,r,i,esize
  ...
  diff = r-(p[3]*(timmi2_shift(i,p[0],p[1]))+p[2])
  ;; Take the edges of
  sdiff = size(diff)
...
FUNCTION timmi2_fitshift,ref,img,x=x,y=y,boxsize=boxsize,edgesize=edgesize
...
;; Note we expect the ref image to be centered on (160,120)
  ...
  p = amoeba(1d-4,FUNCTION_NAME='timmi2_fitshift_fitfunction', $
