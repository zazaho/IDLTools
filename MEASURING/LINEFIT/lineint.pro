...
function lineint, aar,XRANGE = xrange, OLDDATA=olddata
...
contx(0) = aarline.data(0).wave
conty(0) = aarline.data(0).flux

contx(1) = aarline.data(n_elements(aarline.data)-1).wave
conty(1) = aarline.data(n_elements(aarline.data)-1).flux
